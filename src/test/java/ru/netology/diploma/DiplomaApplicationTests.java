...
import ru.netology.diploma.dto.FileNameInRequest;
...
class DiplomaApplicationTests{
    ...
    public void testLogin() {
        userRepository.save(new UserEntity("mamaeva", "password"));
        final HttpHeaders headers = new HttpHeaders();
        headers.set("Content-Type", "application/json");

        final LoginInRequest operation = new LoginInRequest("mamaeva", "password");
